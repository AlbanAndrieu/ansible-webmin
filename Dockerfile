# Ansible managed: /workspace/users/albandri10/env/ansible/roles/webmin/templates/Dockerfile.j2 modified on 2014-10-30 12:58:39 by albandri on albandri-laptop-misys.misys.global.ad
#FROM        debian:jessie
